...
if __name__ == '__main__':
    ...
    df = df.filter("Start_Lon is not NULL and Start_Lat is not NULL")

    # test func start
    df = df.selectExpr('Start_Lon', 'Start_Lat', 'point_in_polygon(Start_Lon, Start_Lat) as point_in_polygon')
    # test func end
